...
tribble(
  ...
  "Estadística Analítica: regresión logística e introducción a modelos mixtos", "2022", "Dra. Natalia Cernicchiaro (Kansas State University)", "Facultad de Odontología", "GLM | Epidemiología| Lenguaje R",
...
* Delegado representante (alterno) de la Facultad de Veterinaria en el Grupo de Trabajo propuestos por el MGAP sobre "Farmacovigilancia, Inocuidad y Residuos". Designado por Decano de Facultad de Veterinaria (18/5/2022)
