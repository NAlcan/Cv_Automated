...
tribble(
  ...
  "Estadística Analítica: regresión logística e introducción a modelos mixtos", "2022", "Dra. Natalia Cernicchiaro (Kansas State University)", "Escuela de Graduados Facultad de Odontología", "Regresión Logística | Epidemiología| Modelos GLMM",
...
tribble(
  ~ Nombre, ~ Año, ~ Docente , ~InstitucionyLugar,  ~ KeyWords, 
  "Taller Internacional de Formación Docente: Usos de tecnologías en la educación veterinaria", "2021", "Coordinadores: M. V Indiana Rodriguez y Dr. José Passarini", "Programa MARCA - Secretaria General Iberoamericana - MERCOSUR Educativo (virtual)","TICs | Educación Veterinaria | Formación Docente", 
...
tribble(
  ...
  "Bioestadística I (Area I, semestre impar)","2017 - Actualidad", "Médico Veterinario (plan 2021). Facultad de Veterinaria, Udelar", "Planificación del curso, dictado de grupos prácticos, dictado de clases teóricas, confección y corrección de parciales, exámenes",
  "Talleres de apoyo paralelo al Curso de Bioestadística I", "2017 - 2020", "Plan de Desarrollo Estratégico - Facultad de Veterinaria, UdelaR","Planificación del taller, dictado de clases de apoyo en y Seguimiento de los estudiantes seleccionados en el curso de Bioestadística I",
...
tribble(
  ~ Curso, ~ Fecha, ~ Carrera, ~ Rol,
  "R1 - Análisis de datos en R", "ed. 2021 y 2022", "Programa de Posgrado de la Facultad de Veterinaria (PPFV)", "Co-Responsable. Diseño del programa y planificación. Integrante del Tribunal de evaluación. Dictado de clases prácticas y teóricas",
...
tribble(
  ...
  "Evaluación de la capacidad histaminogénica de Lacha (Brevoortia aurea)(Bres. Diego Gérez y María Fernanda Paiva)", "3/2022 - 11/2022"," Doctor en ciencias Veterinarias (plan 1998)", "Orientador: Dr. Santiago Díaz, Co-Orientadores Dr. José Pedro Dragonetti y Msc. Ignacio Alcántara., Rol: Asesoramiento en análisis estadístico", 
  "Uso de Amantadina en la terapia antáglica de caninos con dolor crónico (Bres. Henry Aguiar y Bach. Miguel Panza)", "8/2019 - 11/2020", "Doctor en ciencias Veterinarias (plan 1998)", "Orientador: Dra. Nadia Crosignani, Co-Orientador: Msc. Ignacio Alcántara, Rol: Asesoramiento en análisis estadístico",
