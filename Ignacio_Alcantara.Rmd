...
tribble(
  ...
  "Estadística Analítica: regresión logística e introducción a modelos mixtos", "2022", "Dra. Natalia Cernicchiaro (Kansas State University, USA)", "Escuela de Graduados Facultad de Odontología, UelaR - Montevideo, Uruguay", "Regresión Logística | Epidemiología| Modelos GLMM",
...
tribble(
  ~ Curso, ~ Fecha, ~ Carrera, ~ Rol, 
  "Taller Internacional de Formación Docente: Uso de Tecnologías en la Educación Veterinaria. (2021)", "2021", "Programa MARCA - Secretaria General Iberoamericana - MERCOSUR Educativo", "Charlas:
        \" Elaboración de cuestionarios para Moodle usando el software R\". Rosenstock N., Alcántara I., Bobadilla P. | \"Indicadores basados en registros de Moodle para el seguimiento de la actividad estudiantil\". Bobadilla P., Alcántara I., Rosenstock N.",
...
tribble(
  ~ title, ~ author, ~ year, ~ jornadas, ~ modalidad,
  "Development of drug-drug interaction models in vitro for macrocyclic lactones and their understanding","Gonzalo Suárez, Ignacio Alcántara, Gustavo Salinas", "2022","RedIF Congress 2022; Ibero-American network in pharmacometrics", "Póster",
...
agricultura y las cianobacterias \" ", "Medio: La Diaria", "2021", "link: https://ladiaria.com.uy/ciencia/articulo/2021/12/la-contundente-respuesta-de-53-investigadores-a-un-paper-que-afirma-que-no-hay-relacion-entre-la-agricultura-y-las-cianobacterias/. Publicado el: 04/12/2021",
 ...
 "Qué estudian los que estudian: Cianobacterias y Alertas tempranas", "Programa Justicia Infinita radio Océano", "2018",
